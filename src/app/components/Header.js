  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-100 shadow-sm">
      <div className="flex items-center space-x-3">
        ...
        <h1 className="text-lg font-semibold text-gray-800">Database Designer</h1>
        <p className="text-xs text-gray-500">Visual Schema Editor</p>
      </div>
      <div className="flex items-center space-x-2">
        <button
          onClick={onFetchDatabases}
          className="px-4 py-1.5 bg-indigo-500 text-white rounded-md hover:bg-indigo-600 transition-colors flex items-center space-x-1 text-sm"
        >
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search"
            className="pl-8 pr-3 py-1.5 bg-gray-100 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-shadow"
          />
          <svg className="w-4 h-4 text-gray-500 absolute left-2.5 top-1/2 transform -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
